    ...
    */
    describe('completeOffline', () => {
        it('completeOffline successful', () => {
            ...
            let transactionCompletion: TrustPayments.model.TransactionCompletion;
            ...
            .delay(7500)
            .done((response: { response: http.IncomingMessage, body: TrustPayments.model.TransactionCompletion }) => {
                transactionCompletion = response.body;
                expect(transactionCompletion.state).to.equal(TrustPayments.model.TransactionCompletionState.SUCCESSFUL);
            });
        });
    });
