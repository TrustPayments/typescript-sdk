...
class SubscriptionProductVersionRetirementService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const localVarPath = '/subscription-product-version-retirement/count';
    ...
    */
    public create (spaceId: number, retirement: SubscriptionProductVersionRetirementCreate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductVersionRetirement;  }> {
        const localVarPath = '/subscription-product-version-retirement/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductVersionRetirement;  }> {
        const localVarPath = '/subscription-product-version-retirement/read';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<SubscriptionProductVersionRetirement>;  }> {
        const localVarPath = '/subscription-product-version-retirement/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
