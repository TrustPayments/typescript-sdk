...
class SubscriptionProductPeriodFeeService {
    ...
    */
    public _delete (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = '/subscription-product-period-fee/delete';
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const localVarPath = '/subscription-product-period-fee/count';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public create (spaceId: number, entity: ProductPeriodFeeUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductPeriodFee;  }> {
        const localVarPath = '/subscription-product-period-fee/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductPeriodFee;  }> {
        const localVarPath = '/subscription-product-period-fee/read';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<ProductPeriodFee>;  }> {
        const localVarPath = '/subscription-product-period-fee/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public update (spaceId: number, entity: ProductPeriodFeeUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductPeriodFee;  }> {
        const localVarPath = '/subscription-product-period-fee/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
