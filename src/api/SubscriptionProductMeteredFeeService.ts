...
class SubscriptionProductMeteredFeeService {
    ...
    */
    public _delete (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/subscription-product-metered-fee/delete';
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const localVarPath = this.basePath + '/subscription-product-metered-fee/count';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public create (spaceId: number, entity: ProductMeteredFeeUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductMeteredFee;  }> {
        const localVarPath = this.basePath + '/subscription-product-metered-fee/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductMeteredFee;  }> {
        const localVarPath = this.basePath + '/subscription-product-metered-fee/read';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<ProductMeteredFee>;  }> {
        const localVarPath = this.basePath + '/subscription-product-metered-fee/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public update (spaceId: number, entity: ProductMeteredFeeUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductMeteredFee;  }> {
        const localVarPath = this.basePath + '/subscription-product-metered-fee/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
